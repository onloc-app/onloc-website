...
Open **"Edit Compose File"** and paste the contents of the [docker-compose.yml file](https://github.com/onloc-app/onloc-deployment/blob/main/docker-compose.yml) from the deployment repository.
